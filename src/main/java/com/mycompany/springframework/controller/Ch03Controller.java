...
public class Ch03Controller {
	...
	public String requestParamAnnotation(
			...
			Model model) {
		log.info("requestParamAnnotation() 실행"); 
	...
	public String requestParamAnnotationRequired(
			...
			String param6, 
			Model model) {
		log.info("requestParamAnnotationRequired() 실행"); 
...
//		log.info("param5: " + dto.getParam5());
	...
	@PostMapping(value="/getAjaxParams", 
			produces="application/json; charset=UTF-8") // json을 리턴해보자.
	@ResponseBody
	public String getAjaxParams(Ch03Dto dto) {
		...
		jsonObject.put("param4", dto.isParam4()); // boolean의 게터는 is로 시작
