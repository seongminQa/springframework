							    ...
							    <tbody>
							    	<c:forEach var="cartItem" items="${cart}">
								      <tr>
								        ...
								        <!-- id값은 유일한 값이어야 한다. 하지만 for문이 돌기 때문에 amount를 사용하는 것은 부적절하다. -->
								        <%-- <td><input type="number" id="amount" value="${cartItem.amount}" style="width:60px;" /></td> --%>
								        <td><input type="number" id="amount${cartItem.product.pno}" value="${cartItem.amount}" style="width:60px;" /></td>
								        <td>
